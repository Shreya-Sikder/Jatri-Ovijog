...
import { BusCompanyList } from './pages/BusCompanyList/BusCompanyList';
import { CreateBusCompany } from './pages/BusCompanyList/CreateBusCompany'; // Import the new component
...
export default function App() {
  ...
  switch (path) {
    ...
    case '/create-bus-company': // Add the new route
